# Documentation technique - NationsHistoire

## Objectif technique
Implementer et maintenir la fonctionnalite NationsHistoire de maniere robuste, testable et securisee.

## Routes principales
GET /histoire ; GET /nations ; GET /nations/{nation}

## Controllers
HistoireController@index, NationController@index/show

## Modeles/entites
Nation, SousRegion, Chronologie, Evenement

## Vues / UI
resources/views/histoire/* ; resources/views/nations/*
