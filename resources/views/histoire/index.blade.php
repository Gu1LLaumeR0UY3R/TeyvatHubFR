...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center gap-3 mb-2">
                                    ...
                                    @endif
                                    @if($event->region)
                                        <span class="text-hub-text-sec text-xs">{{ $event->region->nom_region }}</span>
                                    @endif
                                </div>
    ...
    <section>
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('regions.index') }}" class="text-hub-primary hover:underline text-sm">Voir toutes →</a>
        </div>
